...
export const fileClinicalObstetricSearchNumberApi = (id) => apiHttp('GET', `${fileClinicalObstetricPath}/search/${id}`)
...
export const fileClinicalObstetricAllNotNeonatologyApi = () => apiHttp('GET', `${fileClinicalObstetricPath}/not-neonatology`)
