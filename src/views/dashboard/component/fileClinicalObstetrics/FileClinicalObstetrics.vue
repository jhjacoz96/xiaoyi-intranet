        ...
        <v-row>
          <v-col md="auto">
            <div class="text-h3 font-weight-medium">
              Ficha clínica de obstetricia
            </div>
            <div class="text-subtitle-1 font-weight-light">
              Perminite administrar las fichas clinicas de obtetricia
            </div>
          </v-col>
        </v-row>
      </template>
        ...
        <v-row class="justify-center">
          <v-col cols="3">
            <base-item-master
              ...
              to="ficha-clinica-obstetricia/seguimiento"
            />
          </v-col>
          <v-col cols="3">
        ...
        <v-card>
          ...
          <v-card-text>
            <v-alert
              ...
              elevation="2"
            >
              Para poder registrar una nueva ficha clinica de obtetricia, se debe verificar que la paciente sea miembro de una ficha familiar existente.
            </v-alert>
          </v-card-text>
          <v-card-text>
            <v-container>
