        ...
        <v-row>
          ...
          <v-col md="auto">
            <div class="text-h3 font-weight-medium">
              Grupos de semanas de gestación
            </div>
            <div class="text-subtitle-1 font-weight-light">
              Permite gestionar los grupos de semanas de gestación del embarazo
            </div>
          </v-col>
        </v-row>
        <v-btn
...
<script>
  export default {
    ...
    computed: {
      formTitle () {
        return this.editedIndex === -1 ? 'Agregar grupo de semanas de gestción' : 'Editar grupo de semanas de gestción'
      },
    },
    watch: {
      dialog (val) {
