              ...
              <v-row>
                ...
                >
                  <v-select
                    ...
                    label="Segundo filtro de busqueda"
                    outlined
                    :items="filterTwo"
                    item-text="name"
                    item-value="id"
...
<script>
  ...
  export default {
    data () {
      return {
        ...
        headers: [
          ...
          {
            text: 'Segundo filtro de busqueda',
            value: 'filter_two_publication_id.name',
          },
          {
            text: 'Acción',
            sortable: false,
    ...
    created () {
      this.listItem()
      this.listItemFilterTwo()
    },
    methods: {
      ...mapActions('filterThreePublication', ['filterThreePublicationPostActions', 'filterThreePublicationAllActions', 'filterThreePublicationDeleteActions', 'filterThreePublicationGetActions', 'filterThreePublicationUpdateActions']),
      ...mapActions('filterTwoPublication', ['filterTwoPublicationAllActions']),
      ...mapMutations(['alert']),
      async listItem () {
        const serviceResponse = await this.filterThreePublicationAllActions()
      ...
      async deleteItemConfirm () {
        const serviceResponse = await this.filterThreePublicationDeleteActions(this.editedId)
        if (serviceResponse.ok) {
      ...
      async addItem () {
        if (this.editedIndex > -1) {
          ...
          const serviceResponse = await this.filterThreePublicationPostActions(this.editedItem)
          if (serviceResponse.ok) {
