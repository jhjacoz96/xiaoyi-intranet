...
<script>
  ...
  import {
    reportStadisticFileObstatricTypeBirthApi,
    gestationWeekAllApi,
  } from '@/api/modules'
  export default {
    data () {
    ...
    methods: {
      ...
      ...mapActions('gestationWeek', ['gestationWeekAllActions']),
      async listItem () {
        const serviceResponse = await reportStadisticFileObstatricTypeBirthApi(this.filter)
